...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname: "will", email: "will@example.com",
  ...
  test "email should accept correct format" do
    valid_emails = %w[user@example.com MASHRUR@gmail.com M.first@yahoo.com john+smith@co.uk.org]
  ...
  test "email should reject invalid addresses" do
    invalid_emails = %w[will@exaple will@example,com will.name@gmail. joe@bar+foo.com]
  ...
  test "email should be uniqueand case sensitive" do
